function Button({ type, size, children, action, hasBorder }) {
  ...
  const buttonClasses = `text-center p-2 rounded-full z-10 w-32 text-white cursor-pointer text-xs md:text-base lg:text-lg sm:text-sm ${typeClass} ${sizeClass} ${borderClass}`;
